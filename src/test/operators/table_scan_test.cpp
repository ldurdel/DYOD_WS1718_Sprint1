...
TEST_F(OperatorsTableScanTest, ScanOnDictColumn) {
  ...
  tests[ScanType::OpAll] = {100, 102, 104, 106, 108, 110, 112, 114, 116, 118, 120, 122, 124};
  tests[ScanType::OpNone] = {};
...
TEST_F(OperatorsTableScanTest, ScanOnReferencedDictColumn) {
  ...
  tests[ScanType::OpAll] = {100, 102, 104, 106};
  tests[ScanType::OpNone] = {};
...
TEST_F(OperatorsTableScanTest, ScanOnDictColumnValueGreaterThanMaxDictionaryValue) {
  ...
  tests[ScanType::OpAll] = all_rows;
  tests[ScanType::OpNone] = no_rows;
